...
#define RCP_KEEP_ALIVE_TIMEOUT_DEF		2
    ...
    while(1) 
    {
		...
		if(gulEnableEpswitchMgt)
		{
			...
			{
#if 0/*为规避bug，尽量减少RCP交互.wug2014.9.10*/
				for(i=1; i<MAX_RRCP_SWITCH_TO_MANAGE; i++)
				{
					if(RCP_Dev_Is_Valid(i))
					{
...
unsigned long  switchlooopfloodenable = 0;
