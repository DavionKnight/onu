...
//				gw_log(GW_LOG_LEVEL_DEBUG,"get stop loop led if is null!\r\n");
        ...
        case LIB_IF_TVM_RELATION_TABEL_ITEM_ADD:
        	if(g_im_ifs->tvmitemadd)
                ...
                printf("gwdonu add tvm tabel  is NULL\n");
            break;
        ...
        case LIB_IF_TVM_RELATION_TABEL_COUNT:
        	if(g_im_ifs->tvmcount)
                ...
                printf("gwdonu get tvm relation tabel count is NULL\n");
            break;
/************************************************/
        ...
        case LIB_IF_CTC_VLAN_MODE_GET:
        	...
        	break;
        case LIB_IF_DHCP_RULE_MODE_SET:
        	if(g_im_ifs->dhcprelayruleset)
        		ret=(*g_im_ifs->dhcprelayruleset)(va_arg(ap,unsigned int));
        	else
        		printf("gwdonu set dhcp rule mode is null\r\n");
        	break;
		default:
